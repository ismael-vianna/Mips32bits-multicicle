    ...
    begin     
        case ula_cntrl is
            when "00000" =>                                               -- calculado no estado 1, load e store e R                
                ...
                --ula_out <= ula_entrada_a + ula_entrada_b;
...
--                ula_out <= ula_entrada_a(31 downto 0) and ula_entrada_b(31 downto 0);
                --ula_out(0) <= '0';
                ula_flag_zero <= '0';
                erro_ula <= er_livre;
            when "00011" =>                                               -- branch beq. se numA - numB = 0, entao sao iguais
                ...
                if (auxiliar_ula = ZEROS32) then--if ((ula_entrada_a xor ula_entrada_b) = ZEROS32) then 
            ...
            when "10001" =>                                               -- sll, c = a << imediato16
                case unsigned(ula_entrada_b(5 downto 0)) is
                    ...
                    when "000010" => --2
                        ...
                        --ula_out <= ula_entrada_a(29 downto 0) & ZEROS32(1 downto 0);
                    when "000011" => --3
   ...
   BANCO_REGISTRADORES_HW_CARREGA_ULA: process(clk, rst, escreve_registrador)
    ...
    bnk_reg_escreve_dado <= std_logic_vector(unsigned(ula_out))         when reg_mem = "00" else 
                            ...
                            std_logic_vector(unsigned(registrador_mdr) + unsigned(registrador_b));
